...
const I18N = {
  ja: {
    ...
    "settings.sweet_spot_h4": "Sweet Spot（タグ <code>sweet_spot</code>）",
    "settings.sweet_spot_low": "下限(%FTP)",
    "settings.sweet_spot_high": "上限(%FTP)",
    "settings.sweet_spot_tag_min_pct": "タグ付与の最低滞在率(%)",
    "settings.sweetspot_h4": "Sweet Spot（タグ <code>sweetspot</code>・厳格版、tempo/thresholdと共存）",
  ...
  en: {
    ...
    "settings.sweet_spot_h4": "Sweet Spot (tag <code>sweet_spot</code>)",
    ...
    "settings.sweetspot_h4": "Sweet Spot (tag <code>sweetspot</code> — strict, coexists with tempo/threshold)",
